...
public class CommandUtil {
    ...
    private static void executeCommand(Player player, String action) {
        if (action.startsWith("[")) {
            ...
            ActionType type = ActionType.fromString(typeString);
            if (type == null) {
            ...
            // 缓存配置文件中的 URL 和玩家名字
            String commandContent = setString(player.getName(), parts);
            // 使用 PAPI 解析变量
            ...
            switch (type) {
                ...
                case CLOSE:
                    ...
                    break;
                case OPEN:
                    handleOpActionenAction(player, commandToExecute);
                    break;
                case TITLE:
    ...
    @NotNull
    private static String setString(String playerName, String[] parts) {
        // 获取原始内容
    ...
    private static void handleOpActionenAction(Player player, String command) {

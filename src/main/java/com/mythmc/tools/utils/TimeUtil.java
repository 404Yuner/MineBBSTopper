...
public class TimeUtil {
    ...
    private static final String REFORMAT = "yyyy-MM-dd HH:mm:ss";
    public static String convertTimestamp(long Timestamp) {
        ...
        SimpleDateFormat formatter = new SimpleDateFormat(REFORMAT, Locale.getDefault());
        // 返回格式化后的时间字符串
        return formatter.format(date);
    }
    public static long convertDataTime(String dateTimeStr) {
        // 预设时间格式
        SimpleDateFormat formatter = new SimpleDateFormat(REFORMAT);

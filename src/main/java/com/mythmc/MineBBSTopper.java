...
public final class MineBBSTopper extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        metrics.addCustomChart(new Metrics.AdvancedPie("database_type", () -> Collections.singletonMap(ConfigFile.DataType.toUpperCase(), 1)));
    ...
    public void cacheClear() {
        ...
        HolographicDisplaysHook.removeHologram();
